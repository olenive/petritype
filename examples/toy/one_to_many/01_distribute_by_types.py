...
def _(mo):
    mo.md(
        r"""
        # One to many — distribute by type

        In this example, tokens output by a transition function are distributed to the
        destination place whose declared type matches the token's type.
